...
return [
    ...
    */
    ...
    'menu' => [
        ...
        //     'text' => 'history',
        //     'url' => '#',
        //     'icon' => 'fa-solid fa-fw fa-history',
        // ],
        ['header' => 'config'],
        // [
        //     'text' => 'andon',
        //     'url' => '/home',
        //     'icon' => 'fa-solid fa-fw fa-tower-observation',
        // ],
        [
            'text' => 'user',
            'route' => 'user.index',
        ...
        [
            'text' => 'part_number',
            'route' => 'part-number.index',
            'icon' => 'fa-solid fa-fw fa-hammer',
        ],
        [
            'text' => 'worker',
            'route' => 'worker.index',
            'icon' => 'fa-solid fa-fw fa-person',
        ],
        [
            'text' => 'planned_outage',
            'route' => 'planned-outage.index',
            'icon' => 'fa-solid fa-fw fa-stop',
        ],
        [
            'text' => 'raspberry_pi',
            'route' => 'raspberry-pi.index',
            'icon' => 'fab fa-fw fa-raspberry-pi',
        ],
        // [
        //     'text' => 'profile',
        //     'url' => 'admin/profile',
