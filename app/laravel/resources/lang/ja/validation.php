...
return [
    ...
    */
    ...
    'color'                => ':attributeに正しい形式を指定してください。',
    ...
    'mac_address' => '有効なMACアドレスを指定してください。',
    'max'                  => [
    ...
    */
    ...
    'attributes' => [
        ...
        'pin_number'                    => 'ピン番号',
        'plan_color'                    => '計画値色',
        'planned_outage_id'             => '計画停止時間',
        'planned_outage_name'           => '計画停止時間名',
        'process_name'                  => '工程名',
        'raspberry_pi_id'               => 'ラズベリーパイ',
        'raspberry_pi_name'             => 'ラズベリーパイ名',
        'remark'                        => '備考',
        'role'                          => '権限',
        'row_count'                     => '行数',
        'sensor_type'                   => 'センサー種別',
